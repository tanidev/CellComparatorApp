...
public class RankingBean implements Serializable {
	...
	@Inject @RankingDAO
	private RankingDAOImpl rankingDAOImpl;
	...
	public void init() {
		...
		rankingResultDTO = rankingDAOImpl.findByChart(new RankingFilter(new Date(), new Date()));
		barModel = null;
	...
	public void findByRankingType() {
		...
		rankingResultDTO = rankingDAOImpl.findByChart(rankingType.getRankingFilter());
		barModel = null;
