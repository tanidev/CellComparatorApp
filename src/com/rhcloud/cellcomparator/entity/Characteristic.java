...
@Entity
@SequenceGenerator(name="characteristicSeq", sequenceName="characteristicSeq", allocationSize=1)
public class Characteristic {
	
	@Id
	@GeneratedValue(generator="characteristicSeq", strategy=GenerationType.SEQUENCE)
